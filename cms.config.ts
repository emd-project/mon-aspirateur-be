  ...
  collections: {
    ...
    pages: {
      ...
      fields: {
        ...
        image1: { type: 'image', label: 'Accueil — Image 1 (bande « Le terrain »)' },
        image1Alt: { type: 'text', label: 'Accueil — Image 1 — texte alternatif' },
        image1Caption: { type: 'text', label: 'Accueil — Image 1 — légende' },
        image2: { type: 'image', label: 'Accueil — Image 2 (optionnel)' },
        image2Alt: { type: 'text', label: 'Accueil — Image 2 — texte alternatif' },
        image2Caption: { type: 'text', label: 'Accueil — Image 2 — légende' },
        image3: { type: 'image', label: 'Accueil — Image 3 (optionnel)' },
        image3Alt: { type: 'text', label: 'Accueil — Image 3 — texte alternatif' },
        image3Caption: { type: 'text', label: 'Accueil — Image 3 — légende' },
      },
    },
  },
  media: {
