...
export const brands: Brand[] = [
  {
    ...
    categories: ['balai', 'traineau', 'laveur', 'robot'],
    topProducts: [
      {
        ...
        priceEur: 399,
        score: 9.0,
        highlight: 'Brosse flexsimo qui passe sous les meubles sans se plier en quatre — 65 min réels',
        affiliateUrl: '#',
        isTopPick: true,
      },
      {
        ...
        priceEur: 299,
        score: 8.7,
        highlight: '65 dB mesuré — le traîneau le plus silencieux sous les 300 €',
        affiliateUrl: '#',
        isTopPick: true,
      },
      {
        name: 'Rowenta X-Plorer Serie 75 RG7887',
        category: 'robot',
        priceEur: 299,
        score: 7.9,
        highlight: 'Navigation systématique à 299 € — le robot Rowenta qui tient ses promesses',
        affiliateUrl: '#',
        isTopPick: true,
      },
      {
