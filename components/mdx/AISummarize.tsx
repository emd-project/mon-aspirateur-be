...
const ASSISTANTS = [
  ...
  },
  {
    ...
    color: '#FF7000',
    bg: 'rgba(255,112,0,.1)',
    url: (q: string) => `https://chat.mistral.ai/chat?q=${encodeURIComponent(q)}`,
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
  ...
  },
  {
    name: 'Perplexity',
    color: '#20B2AA',
    bg: 'rgba(32,178,170,.1)',
    url: (q: string) => `https://www.perplexity.ai/?q=${encodeURIComponent(q)}`,
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
